...
class GraspActionClient(py_trees.behaviour.Behaviour):
    ...
    def update(self):
        ...
        if not self.sent_goal:
            ...
            self.action_goal.target_pose.pose.position.x = self.blackboard.qrcode_pose.pose.position.x + 0.03
...
#	            self.action_goal.target_pose.pose.position.y = self.blackboard.qrcode_pose.pose.position.y - (self.blackboard.qrcode_pose.pose.position.y/8.0)
	            ...
	            self.action_goal.target_pose.pose.position.y = self.blackboard.qrcode_pose.pose.position.y
	            self.action_goal.target_pose.pose.position.z = self.blackboard.qrcode_pose.pose.position.z + 0.04
...
#            theta = math.atan2(self.blackboard.qrcode_pose.pose.position.y, self.blackboard.qrcode_pose.pose.position.x)
